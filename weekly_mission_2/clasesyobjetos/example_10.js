...
class Explorer{
  ...
  class Estudiante extends Explorer{
    constructor(name,username,mission,cycle,age){
  ...
  const estudiante1= new Estudiante("Ricardo","jricardo","nodeJS","Abril 2022","27")
  console.log("Clase sobreescribiendo, agregando edad")
